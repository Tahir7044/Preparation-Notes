...
- Gate (abstract)
    - EntryGate  → parkVehicle(vehicle, entryTime) : String (ticketId)
...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        Future<String> f1 = executor.submit(() -> entryGate.parkVehicle(bike1, entryTime));
        Future<String> f2 = executor.submit(() -> entryGate.parkVehicle(bike2, entryTime));
        String bikeTicketId1 = f1.get();
        String bikeTicketId2 = f2.get();
        executor.shutdown();
        System.out.println("Bike1 ticketId: " + bikeTicketId1);
        System.out.println("Bike2 ticketId: " + bikeTicketId2);
        ...
        String carTicketId = entryGate.parkVehicle(car, entryTime);

        System.out.println("----- Parking Status (after car park) -----");
        lot.printStatus();

        LocalDateTime exitTime = LocalDateTime.of(2025, 5, 21, 13, 15);
        exitGate.unparkVehicle(carTicketId, exitTime, PaymentMode.UPI);
